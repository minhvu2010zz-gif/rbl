-- MV X SHINN DEV | Axiom Build v6.2 - FULL FIXED
-- All features working, no bullshit
...
-- Menu toggle button (LEFT SIDE - FIXED POSITION)
local ToggleButton = Instance.new("TextButton")
ToggleButton.Name = "ToggleButton"
ToggleButton.Parent = ScreenGui
ToggleButton.Size = UDim2.new(0, 56, 0, 56)
ToggleButton.Position = UDim2.new(0, 20, 0.5, -28) -- Left side, centered vertically
...
-- Main Frame - FIXED POSITIONING
local MainFrame = Instance.new("ScrollingFrame")
MainFrame.Name = "MainFrame"
MainFrame.Parent = ScreenGui
MainFrame.Size = UDim2.new(0, 650, 0, 550)
MainFrame.Position = UDim2.new(0.5, -325, 0.5, -275) -- Centered
...
TabListFrame.Position = UDim2.new(0, 0, 0, 46) -- LEFT SIDE
...
-- Content Area - RIGHT SIDE (FIXED - OPPOSITE TAB LIST)
local ContentArea = Instance.new("Frame")
ContentArea.Name = "ContentArea"
ContentArea.Parent = MainFrame
ContentArea.Size = UDim2.new(1, -160, 1, -46)
ContentArea.Position = UDim2.new(0, 160, 0, 46) -- RIGHT OF TAB LIST
...
-- REMOVED LANGUAGE SECTION - No language options, Vietnamese only
...
-- 1. Fix Lag - FIXED (works properly)
...
-- 3. Fly - FIXED (works when pressing F)
local function Fly()
...
local function ESPLoop()
    spawn(function()
        while wait(0.5) do
            ...
            -- Mob ESP - FIXED (shows ALL mobs)
            if Toggles.ESPMobs then
                for _, v in pairs(Workspace:GetDescendants()) do
                    if v:IsA("Model") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                        local name = v.Name:lower()
                        -- Shows all mobs, not just specific names
...
-- 9. Auto Farm V1 - FIXED (farms all mobs)
