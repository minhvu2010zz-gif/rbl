-- MV X SHINN DEV | Axiom Build v7.0
-- FULL FIXED - All Features Working Perfectly
...
-- // Lưu các UI elements để update ngôn ngữ
local UIElements = {
    labels = {},
    buttons = {},
    toggles = {},
...
function ScanMap()
    ...
    print("🔍 Đã tìm thấy " .. #DetectedMapPoints .. " điểm map và " .. #AllMobsInMap .. " quái")
end
...
local adminCard, adminLabels = AddInfoCard(tabAdmin, {
    ...
    { labelKey = "version", key = "version", value = "v7.0 - Full Features" },
...
local announceBtn = AddButton(tabAdmin, "announce", function()
    print("📢 MV X SHINN DEV v7.0 - Đã sẵn sàng!")
end)
...
local function ESPLoop()
    spawn(function()
        while wait(0.5) do
            ...
            -- Mob ESP - Tất cả quái trong map
            if Toggles.ESPMobs then
                for _, v in pairs(Workspace:GetDescendants()) do
                    if v:IsA("Model") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                        -- Bắt tất cả quái (bao gồm quái thường)
...
-- 9. Auto Farm V1 - Tất cả quái trong map
function StartAutoFarm()
    ...
    spawn(function()
        while autoFarmRunning and Toggles.AutoFarm do
            ...
            -- Tìm tất cả quái trong map
            for _, v in pairs(Workspace:GetDescendants()) do
                if v:IsA("Model") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                    -- Lấy tất cả quái (bao gồm NPC, Mob, Boss, Enemy)
            ...
            if nearestMob and nearestDist < 150 then
                ...
                if nearestMob then
                    ...
                    -- Di chuyển random nếu không có quái
...
print("⚡ MV X SHINN DEV v7.0 - FULL FIXED - LOADED SUCCESSFULLY!")
...
ShowNotification("⚡ MV X SHINN DEV v7.0", "Đã tải thành công! Nhấn M để mở menu")
