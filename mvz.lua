-- MV X SHINN DEV | Axiom Build v6.1
...
TitleLabel.Text = "⚡ MV X SHINN DEV v6.1"
...
ToggleButton.MouseButton1Click:Connect(function()
    ...
    if MainFrame.Visible then
        -- Cập nhật canvas size khi mở menu
        MainFrame.CanvasSize = UDim2.new(0, 0, 0, 0)
        wait(0.1)
        MainFrame.CanvasSize = UDim2.new(0, 0, 0, 0)
        MainFrame.AutomaticCanvasSize = Enum.AutomaticSize.Y
...
-- // ===== TAB MAIN =====
AddLabel(tabMain, "🎮 MV X SHINN DEV v6.1 - Full Features")
...
print("⚡ MV X SHINN DEV v6.1 - FULL FIXED - LOADED SUCCESSFULLY!")
...
ShowNotification("⚡ MV X SHINN DEV v6.1", "Đã tải thành công! Nhấn M để mở menu")
