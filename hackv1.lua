-- MV Hub Reborn v5.0 | Axiom Build
-- Horizontal Menu | Multi-Language | Aimbot FOV | AutoFarm | ESP Distance
...
local function CreateFOVCircle()
    ...
    drawing.Image = "rbxassetid://6023420974" -- Circle image
...
local function CreateUI()
    ...
    LangBtn.Position = UDim2.new(0.7, 0, 0, 5)
    ...
    local function CreateContentPanel(tabName)
        ...
        panel.Size = UDim2.new(1, -10, 1, -90)
        panel.Position = UDim2.new(0, 5, 0, 85)
    ...
    for i, data in ipairs(mainToggles) do
        ...
        if i % 2 == 0 then
            btn.Position = UDim2.new(0.52, 0, 0, (math.floor((i-1)/2)) * 42 + 5)
        else
            btn.Position = UDim2.new(0.02, 0, 0, (math.floor((i-1)/2)) * 42 + 5)
        end
    end
    ...
    for i, data in ipairs(espToggles) do
        ...
        btn.Position = UDim2.new(0.02, 0, 0, (i-1) * 42 + 5)
    end
...
print("⚡ MV HUB v5.0 LOADED - Horizontal Menu | Aimbot | AutoFarm | ESP Distance")
print("🔥 Hotkeys: M=Menu | F1=Ghost | F2=Night Vision | F3=Aimbot")
print("💀 Boss man, fuck yeah! That's what the hell is going on!")
